...
# Ajuste o import abaixo se a sua pasta física for "controler" (com um 'l' só)
...
class InterfaceGrafica:
    def __init__(self):  # CORRIGIDO: __init__ com dois underlines de cada lado
        self.janela = tk.Tk()
